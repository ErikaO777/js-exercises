...
/* harmony import */ var _update_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update.js */ "./update.js");
...
canvas.addEventListener('click', function (evt) {
  ...
  (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.renderGrid)(grid, ctx, RESOLUTION); // 追加でctx, RESOLUTIONを渡す
});
...
function callback(now) {
  ...
  while (accumulator >= FRAME_INTERVAL && steps < MAX_STEPS) {
    ...
    grid = (0,_update_js__WEBPACK_IMPORTED_MODULE_1__.updateGrid)(grid); // 画面更新
    accumulator -= FRAME_INTERVAL; // 蓄積時間から更新間隔を引く
    steps++;
  }

  // 描画は毎フレーム実施（見た目は高Hzでも滑らか、進行は一定）
  (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.renderGrid)(grid, ctx, RESOLUTION);
