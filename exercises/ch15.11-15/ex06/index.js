...
if (form) {
  form.addEventListener("submit", (e) => {
    ...
    saveToSessionStorage(item); // itemをsessionStorageに保存
...
export function getItems() {
  return JSON.parse(window.sessionStorage.getItem('todoItems')) || [];
}

export function setItems(items) {
  window.sessionStorage.setItem('todoItems', JSON.stringify(items));
}

// 送信されたらsessionStorageに保存するようにする
